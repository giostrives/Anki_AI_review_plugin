...
- `deck_configs`: per-deck settings (languages, level, review mode, whether
  the first field holds the word being learned or its meaning,
  `include_subdecks`). Easiest to edit from the dialog's deck list.
